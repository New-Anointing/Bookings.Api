...
namespace Bookings.Modules.Ticketing.Infrastructure.DataBase.Migrations
{
    [DbContext(typeof(TicketingDbContext))]
    [Migration("20250921101801_Events_ttype_ticket_order_oitems_payments_migrations")]
    partial class Events_ttype_ticket_order_oitems_payments_migrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Payment.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.HasOne("Bookings.Modules.Ticketing.Domain.Events.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.HasOne("Bookings.Modules.Ticketing.Domain.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bookings.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("Bookings.Modules.Ticketing.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("Bookings.Modules.Ticketing.Domain.Events.TicketType", null)
                        .WithMany()
